...
namespace Editor
{
    public class FindOperationsWindow : EditorWindow
    {
        ...
        private bool m_RemoveOnlySumToggle;
        ...
        private void OnGUI()
        {
            ...
            m_RemoveOnlySumToggle = EditorGUILayout.Toggle("Only Sum Filter",m_RemoveOnlySumToggle);
            if (m_RemoveOnlySumToggle)
            {
                m_Specifications.Add(new SolutionWithoutOnlySum());
            }
